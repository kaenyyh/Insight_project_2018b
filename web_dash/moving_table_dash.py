...
def generate_histogram(interval):
    user = session.execute("SELECT username FROM flaggedUser LIMIT 1")
    username = user[0].username
    rows = session.execute("SELECT * FROM singleUserCount WHERE username = \'{}\'".format(username))
